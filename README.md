...
4. Тесты оформления заказа:
   - [x] Проверка перехода к оформлению заказа.
   - [x] Проверка заполнения информации о покупателе.
   - [x] Проверка перехода к подтверждению оформления заказа.

5. Тесты подтверждения оформления заказа:
   - [x] Проверка отображения информации о заказе.
   - [x] Проверка завершения оформления заказа.
   - [x] Проверка кнопки возврата.

6. Тесты карточек товаров:
   - [x] Проверка отображения карточки товара.
   - [x] Проверка добавления товара в корзину из карточки.
   - [x] Проверка удаления товара из корзины из карточки.
   - [x] Проверка перехода к карточке товара из страницы товаров.
   - [x] Проверка соответствия информации в карточке товара с информацией на странице товаров.

7. Тесты бургер-меню: (Не реализованно)
   - [x] Проверка отображения бургер-меню.
   - [x] Проверка перехода к странице "All Items".
   - [x] Проверка перехода к странице "About".
   - [x] Проверка перехода к странице "Logout".
   - [x] Проверка перехода к странице "Reset App State".
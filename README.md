...
7. Тесты бургер-меню: (Не реализованно)
   ...
   - [] Проверка перехода к странице "All Items".
   - [] Проверка перехода к странице "About".
   - [] Проверка перехода к странице "Logout".
   - [] Проверка перехода к странице "Reset App State".
